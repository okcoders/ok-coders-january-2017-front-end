...
As always, refresh the page to see the effect. This is the power of css and what it can accomplish when the structure of a page is separated from its presentation.
...
For a two sidebar layout, include three columns in the top level row and ensure the largest column is in the center. Just make sure the lengths add up to twelve:
